...
UML类图是项目代码结构梳理的重要工具，通过使用Mermaid，可以快速绘制出类图。这在超大型复杂项目探索中，可以帮助我们快速理解项目结构，并进行系统复刻。简而言之，如果你在探索一个类似vscode的超大型复杂项目，那么UML类图可以代替你的大脑记忆项目各模块的关系和结构，让你能够腾出大脑去专门分析项目代码。